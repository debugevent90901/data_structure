...
class BTreeNode:
    ...
    def pr_print(self, db, number):
        ...
        print(self)
        print("number of Keys:", self.getnumKeys(), "Parent node:",
              self.getParent())
    ...
    def __merge(node1, Key, node2):
        ...
        if node1.getnumKeys() < node2.getnumKeys():
            ...
            for i in range(1, num2 + 1):
                ...
                node2.setData(i,
                              node2.getData(i + node2.getnumKeys() - med + 1))
                node2.setChild(
                    i, node2.getChild(i + node2.getnumKeys() - med + 1))
            ...
            if leftSibling != None:
                ...
                for i in range(1, self.getnumKeys() + 1):
                    ...
                    if leftSibling.getChild(i + oldnumKeys + 1) != None:
                        leftSibling.getChild(i + oldnumKeys +
                                             1).setParent(leftSibling)

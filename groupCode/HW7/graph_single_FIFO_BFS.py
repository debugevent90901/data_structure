# This is the exercise 2 of the HW7
...
class Graph:
    ...
    def bfs(self, vertex):
        ...
        for l in range(length):
            for i in range(currentlayer.length):
                u = currentlayer.popfront()
...
if __name__ == "__main__":
    #edges = [(1, 5), (1, 3), (1, 7),(5, 2),(2, 4),(2, 6),(3, 4),(3, 6)]
    #g = Graph(edges)
    #g.allDFS()
    #for i in g.tree:
    #    print("\n#####")
